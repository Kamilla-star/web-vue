<template>
  ...
  <header class="row header">
    ...
    <footer>
      <h2>Саттарова Камилла Римовна 201-322</h2>
    </footer>
...
export default {
  ...
  data() {
    return {
      ...
      array: '',
      darkMode: false,
      // 3 массива для разных приоритетов задач
      arrBackLog: [
        { name: "Школа", text: 'Сделать математику', date: (new Date()).toLocaleString('en-GB'), priority: '1' },
        { name: "Магазин", text: 'Купить молоко', date: (new Date()).toLocaleString('en-GB'), priority: '3' },
        { name: "Спорт", text: 'Сходить в спортзал', date: (new Date()).toLocaleString('en-GB'), priority: '2' },
      ],
      arrInProgress: [],
      arrDone: []
    };
